...
export const mockData: MockData = {
  ...
  narrativeSections: {
    executiveSummary:
      'Chittagong Shipping Services Ltd. is a Patenga-headquartered coastal logistics operator with FY24 revenue of BDT 223.8M and an Acceptable ICRR (61). Earnings are tied to port throughput, charter-hire pass-through mechanics, and tug utilisation on bulk cement and feed import jobs. Audited financials are clean; Moderate reliability reflects inherent voyage P&L volatility and timing differences between bunker accruals and charter settlements rather than control weaknesses.',
    financialPerformance:
      'Revenue grew 23% FY22–FY24 with stable gross margin near 32% as fuel surcharges were contractually indexed on roughly 78% of lighterage days. EBITDA reached BDT 28.4M; net margin held near 7.5%. A one-off dry-docking expense of BDT 3.1M was booked in Q2 FY24, partially offset by higher summer cement volumes. No material related-party sales; agency commission income from foreign principals grew 9% year-on-year.',
    ...
    leverageDebt:
      'Debt-to-equity improved to 1.65× from 1.91× as retained earnings accumulated and one tug loan tranche matured. Leverage ratio 0.62× is within policy for marine asset portfolios. Interest coverage 4.5× provides cushion against bunker shocks. Remaining term debt amortises through FY29 with no bullet concentration in any single fiscal year.',
    covenantCompliance:
    ...
    riskFlags:
      'Bunker price volatility and regional container slot premiums can compress voyage margins when pass-through clauses lag by 10–15 days. Crew wage inflation (~11% FY24) is partly offset by productivity gains from newer tug. Regulatory risk: any tightening of cabotage crew nationality rules could increase manning cost; management monitors Bangladesh Shipping Corporation policy circulars.',
    recommendation:
