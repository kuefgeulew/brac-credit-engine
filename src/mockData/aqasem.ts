...
export const mockData: MockData = {
  ...
  narrativeSections: {
    executiveSummary:
      'Anwar Textile Mills Ltd. is a mid-sized woven RMG exporter with audited FY23–FY25 statements reviewed under the March 2025 annual renewal. The obligor maintains a Good internal credit risk rating (ICRR 72) with clean covenant history and a stable DSCR trajectory (1.18× → 1.22×). Exposure is predominantly trade-backed (LC / back-to-back) with modest balance-sheet leverage trending down as retained earnings build. Primary watch items are buyer concentration in the EU retail channel and partial Euro invoice exposure against USD-denominated yarn purchases.',
    financialPerformance:
      'Revenue grew from BDT 268.0M (FY23) to BDT 302.5M (FY25), a CAGR of roughly 6.3%, driven by higher average order values on compliance-heavy outerwear programs rather than pure volume growth. Gross profit expanded from BDT 70.0M to BDT 79.5M, holding gross margin near 26% as cotton yarn prices stabilised post-FY24 volatility. EBITDA reached BDT 37.7M in FY25 (+19.6% vs FY23), with net profit at BDT 22.8M, reflecting disciplined overhead control and better absorption across three cutting-sewing- finishing units. Management guidance for FY26 assumes flattish volume but margin support from negotiated fabric conversion terms with nominated mills.',
    liquidityWorkingCapital:
      'Current assets of BDT 134.0M versus current liabilities of BDT 76.5M yield a current ratio of 1.75× at FY25 year-end. Inventory days edged up to 62 (from 55) as a large winter program shipped late in Q4, but post-year-end clearance reduced carrying value by BDT 11.4M per management representation letter. Operating cash flow of BDT 33.8M comfortably exceeded debt service of BDT 18.2M. Packing credit utilisation averaged 71% of sub-limit against eligible export LCs, with no instances of overdue interest in the last 24 months.',
    leverageDebt:
      'Total liabilities to equity improved from 1.56× (FY23) to 1.28× (FY25) as scheduled term amortisation of BDT 3.2M per quarter continued uninterrupted. The leverage ratio (total liabilities / total assets) declined to 0.56, within the bank’s “comfort” band for RMG exposures. Interest coverage strengthened to 5.1× on lower average funding cost after partial repricing to BRAC SME preferential tier. No foreign-currency term debt; all term exposure is BDT-denominated with fixed amortisation through FY29.',
    covenantCompliance:
      'All financial covenants tested positive for FY25: minimum DSCR 1.15× (actual 1.22×), minimum current ratio 1.20× (actual 1.75×), and maximum funded WC utilisation 85% (actual peak 78% in September 2025). The borrower submitted quarterly stock statements and ageing of receivables on time. No cross-default triggers are active. A single technical waiver was granted in FY24 for delayed submission of insurance renewal; documentation was regularised within 14 days.',
    riskFlags:
      'Concentration: five largest buyers represented 58% of FY25 export sales; mitigation includes staggered shipment windows and parent guarantees on two anchor programs. FX mismatch is partial—roughly 32% of invoices are Euro-denominated while yarn imports are largely USD LC—hedging via forward sales is used opportunistically rather than systematically. Sector risk from EU GSP+ rule changes is moderate; the firm holds SMETA audit status renewed through Q1 2026.',
    recommendation:
