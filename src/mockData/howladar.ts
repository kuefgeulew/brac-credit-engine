...
export const mockData: MockData = {
  ...
  regulatory: {
    ...
    crgScore: 5,
    covenantBreaches: [
      'FY25 audited financials: maximum leverage ratio covenant of 0.70× exceeded (actual 0.77×).',
      'FY25 tested minimum interest coverage covenant of 1.25× not met (actual 1.0×).',
    ],
    earlyWarnings: [
      'FY25 net loss after scrap-metal price correction and delayed project billings.',
      'Tightening liquidity: operating cash flow fell short of scheduled principal in FY25.',
    ],
  },
  narrative:
    'Padma Steel & Engineering Ltd. fabricates structural steel and transmission-line towers for domestic EPC contractors, with a workshop in Gazipur and heavy reliance on imported hot-rolled coil. FY25 performance weakened when a large infrastructure milestone slipped to the next fiscal year, compressing revenue and leaving EBITDA thin versus interest expense. The borrower remains operational with an active order book, but breached leverage and interest-coverage covenants trigger heightened monitoring under a Marginal ICRR classification despite an adequate headline DSCR of 1.65× supported by working-capital inflows. Recovery prospects hinge on timely project invoicing, inventory discipline, and a lender-supported covenant reset.',
  borrowerDetails: {
    ...
    collateral:
      'Registered mortgage on workshop & land at Tongi-Gazipur corridor — forced-sale BDT 112M (dated valuation FY23; revaluation pending); charge on machinery BDT 38M net book; personal guarantee of managing director (net worth statement BDT 22M filed Feb 2025).',
  },
  reliabilityScores: {
    completeness: 12,
    consistency: 11,
  ...
  narrativeSections: {
    executiveSummary:
      'Padma Steel & Engineering Ltd. is under Marginal ICRR classification (58) following audited covenant breaches on maximum leverage ratio (0.77× vs 0.70× cap) and minimum interest coverage (1.0× vs 1.25× floor). FY25 shows a net loss of BDT 1.8M, declining EBITDA, and shrinking equity as losses absorb retained earnings. Operating cash flow strengthened to BDT 20.5M on milestone collections, producing DSCR 1.65×, but earnings-based serviceability remains weak. The obligor remains a going concern with an order book of BDT 184M (management letter) but execution risk is acute: delayed milestone billing from a flagship PGCB transmission package compressed FY25 revenue recognition. Audited accounts are unqualified but include emphasis-of-matter paragraph on material uncertainty related to liquidity—warranting Low reliability on spreading alignment.',
    financialPerformance:
      'Revenue declined from BDT 171.2M (FY24) to BDT 164.5M (FY25) despite a strong prior-year pipeline, primarily due to BDT 28M of recognised revenue pushed to FY26 under percentage-of-completion restatement. Gross profit fell to BDT 26.3M; scrap-metal inventory write-down of BDT 4.1M further eroded margin. EBITDA collapsed to BDT 5.1M from BDT 9.9M, insufficient to cover interest and scheduled principal. Net margin turned negative; without parent-level support or covenant waivers, FY26 Q1–Q2 cash gaps are projected at BDT 6–9M unless advance mobilisation payments are released.',
